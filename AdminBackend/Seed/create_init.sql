...
INSERT [dbo].[LocationSpots] ([Id], [Name], [Description], [SpotType], [LocationId], [MaxPersons], [CreatedBy], [CreationDate], [ModifiedBy], [ModificationDate]) VALUES (1, 'Tisch 2 Personen', 'Tisch Anabel', 1, 1, 2, 0, CAST(N'2021-05-11T10:15:48.8982602' AS DateTime2), 0, CAST(N'2021-05-11T10:37:23.4556161' AS DateTime2))

INSERT [dbo].[LocationSpots] ([Id], [Name], [Description], [SpotType], [LocationId], [MaxPersons], [CreatedBy], [CreationDate], [ModifiedBy], [ModificationDate]) VALUES (2, 'Tisch 3 Personen', 'Tisch Susi',   1, 1, 3, 0, CAST(N'2021-05-11T10:15:48.8982694' AS DateTime2), 0, CAST(N'2021-05-11T10:37:23.4556358' AS DateTime2))
